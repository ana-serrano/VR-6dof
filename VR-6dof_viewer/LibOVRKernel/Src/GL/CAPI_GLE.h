...
//         WGL_CONTEXT_FLAGS_ARB, WGL_CONTEXT_DEBUG_BIT_ARB, None };
...
GLE_CLASS_EXPORT class GLEContext {
 public:
  ...
  // CGL).
  // You would typically call this before creating an OpenGL context and using platform-specific
  // functions.
  void PlatformInit();
...
// hooking enabled then we implement our own version of each function.
  ...
  void glColorTable_Hook(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum
  type, const GLvoid *table);
  ...
  void glCopyConvolutionFilter1D_Hook(GLenum target, GLenum internalformat, GLint x, GLint y,
  GLsizei width);
  void glCopyConvolutionFilter2D_Hook(GLenum target, GLenum internalformat, GLint x, GLint y,
  ...
  void glGetSeparableFilter_Hook(GLenum target, GLenum format, GLenum type, GLvoid *row, GLvoid
  *column, GLvoid *span);
  ...
  void glGetHistogram_Hook(GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid
  *values);
