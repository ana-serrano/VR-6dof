...
void OVR::GLEContext::InitVersion() {
  ...
  if (WholeVersion >= 302) {
    ...
    // OpenGL is in compatibility mode,
    // and if not then we are in core profile mode. On Apple another solution would be to use
    // NSOpeNGLPixelFormat
...
//            functionName : "OpenGL")); OVR_UNUSED(functionName);
//            err = glGetError();
//        }
//    }
//}
...
void OVR::GLEContext::PostHook(const char* functionName) {
  if (EnableHookGetError) {
    ...
    // flag has recorded an error, glGetError returns and
...
// GL_ARB_texture_storage
void OVR::GLEContext::glTexStorage1D(
    GLenum target,
    GLsizei levels,
    GLenum internalformat,
    GLsizei width) {
...
void OVR::GLEContext::glTexStorage2D(
    GLenum target,
    GLsizei levels,
    GLenum internalformat,
    GLsizei width,
...
void OVR::GLEContext::glTexStorage3D(
    GLenum target,
    GLsizei levels,
    GLenum internalformat,
    GLsizei width,
...
void OVR::GLEContext::glTextureStorage1DEXT(
    GLuint texture,
    GLenum target,
    GLsizei levels,
    GLenum internalformat,
...
void OVR::GLEContext::glTextureStorage2DEXT(
    GLuint texture,
    GLenum target,
    GLsizei levels,
    GLenum internalformat,
...
void OVR::GLEContext::glTextureStorage3DEXT(
    GLuint texture,
    GLenum target,
    GLsizei levels,
    GLenum internalformat,
...
// GL_ARB_texture_storage_multisample
void OVR::GLEContext::glTexStorage2DMultisample(
    GLenum target,
    GLsizei samples,
    GLenum internalformat,
    GLsizei width,
...
void OVR::GLEContext::glTexStorage3DMultisample(
    GLenum target,
    GLsizei samples,
    GLenum internalformat,
    GLsizei width,
...
void OVR::GLEContext::glTextureStorage2DMultisampleEXT(
    GLuint texture,
    GLenum target,
    GLsizei samples,
    GLenum internalformat,
...
void OVR::GLEContext::glTextureStorage3DMultisampleEXT(
    GLuint texture,
    GLenum target,
    GLsizei samples,
    GLenum internalformat,
...
listBase, FLOAT deviation, FLOAT extrusion, int format, LPGLYPHMETRICSFLOAT lpgmf); }
BOOL OVR::GLEContext::wglUseFontOutlinesA_Hook(HDC hdc, DWORD first, DWORD count, DWORD listBase,
...
listBase, FLOAT deviation, FLOAT extrusion, int format, LPGLYPHMETRICSFLOAT lpgmf); }
BOOL OVR::GLEContext::wglUseFontOutlinesW_Hook(HDC hdc, DWORD first, DWORD count, DWORD listBase,
FLOAT deviation, FLOAT extrusion, int format, LPGLYPHMETRICSFLOAT lpgmf)
{
...
BOOL OVR::GLEContext::wglDescribeLayerPlane_Hook(HDC hdc, int iPixelFormat, int iLayerPlane, UINT
...
int OVR::GLEContext::wglSetLayerPaletteEntries_Hook(HDC hdc, int iLayerPlane, int iStart, int
cEntries, const COLORREF *pcr)
{
...
int OVR::GLEContext::wglGetLayerPaletteEntries_Hook(HDC hdc, int iLayerPlane, int iStart, int
cEntries, COLORREF *pcr)
{
