...
class Log {
 ...
 public:
  ...
  void LogMessage(LogMessageType messageType, const char* fmt, ...) OVR_LOG_VAARG_ATTRIBUTE(3, 4);
  ...
  static void DefaultLogOutput(LogMessageType messageType, const char* formattedText);
