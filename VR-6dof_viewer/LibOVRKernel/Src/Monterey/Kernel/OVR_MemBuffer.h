...
class MemBufferFile : public MemBuffer {
 public:
  ...
  explicit MemBufferFile(eNoInit const noInit); // use this constructor as MemBufferFile( NoInit )
  // -- this takes a parameters so you still can't
  // defalt-construct by accident
