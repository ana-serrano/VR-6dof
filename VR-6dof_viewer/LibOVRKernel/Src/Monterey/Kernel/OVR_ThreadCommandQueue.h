  ...
  class PopBuffer {
   ...
   public:
    ...
    bool NeedsWait() const {
      return toCommand()->NeedsWait();
    }
    NotifyEvent* GetEvent() const {
      return toCommand()->pEvent;
    }
...
class ThreadCommandMF0 : public ThreadCommand {
  ...
  void executeImpl() const {
    pRet ? (void)(*pRet = (pClass->*pFn)()) : (void)(pClass->*pFn)();
  }

 public:
  ThreadCommandMF0(C* pclass, FnPtr fn, R* ret, bool needsWait)
      : ThreadCommand(sizeof(ThreadCommandMF0), needsWait), pClass(pclass), pFn(fn), pRet(ret) {}
...
class ThreadCommandMF1 : public ThreadCommand {
  ...
  void executeImpl() const {
    pRet ? (void)(*pRet = (pClass->*pFn)(AVal0)) : (void)(pClass->*pFn)(AVal0);
  }
...
class ThreadCommandMF2 : public ThreadCommand {
  ...
  void executeImpl() const {
    pRet ? (void)(*pRet = (pClass->*pFn)(AVal0, AVal1)) : (void)(pClass->*pFn)(AVal0, AVal1);
  }
...
class ThreadCommandQueue {
 public:
  ...
  template <class C, class R, class A0, class A1>
  bool PushCallAndWaitResult(
      R (C::*fn)(A0, A1),
      R* ret,
      typename SelfType<A0>::Type a0,
      typename SelfType<A1>::Type a1) {
    return PushCommand(
        ThreadCommandMF2<C, R, A0, A1>(static_cast<C*>(this), fn, ret, a0, a1, true));
  }
